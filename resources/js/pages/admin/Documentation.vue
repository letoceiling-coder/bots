        ...
        <section :id="sections[6].id" class="bg-card rounded-lg border border-border p-6 space-y-4">
            ...
            <div class="prose prose-invert max-w-none space-y-4">
                ...
                <div class="space-y-3">
                    ...
                    <p class="text-muted-foreground">
                        В чате с менеджером поддерживаются все типы медиа:
                    </p>
        ...
        <section :id="sections[8].id" class="bg-card rounded-lg border border-border p-6 space-y-4">
            ...
            <div class="prose prose-invert max-w-none space-y-4">
                <div class="space-y-3">
                    ...
                    <ul class="list-disc list-inside space-y-2 text-muted-foreground ml-4">
                        <li><strong>Сессии:</strong> Информация о каждом пользователе и его сессии</li>
                        <li><strong>Шаги:</strong> Каждый блок, который прошел пользователь</li>
                        <li><strong>Данные:</strong> Все собранные данные (ответы на вопросы)</li>
                        <li><strong>Файлы:</strong> Все загруженные пользователем файлы (документы, фото, видео)</li>
                        <li><strong>Сообщения чата с менеджером:</strong> Полная история переписки</li>
                    </ul>
                </div>
                ...
                <div class="space-y-3">
                    ...
                    <ol class="list-decimal list-inside space-y-2 text-muted-foreground">
                        ...
                        <li>Вы увидите:
                            <ul class="list-disc list-inside ml-6 mt-2 space-y-1">
                                <li>Информацию о пользователе</li>
                                <li>Хронологию всех шагов</li>
                                <li>Собранные данные</li>
                                <li>Загруженные файлы</li>
                                <li>Историю чата с менеджером (если был)</li>
                            </ul>
                        </li>
                    </ol>
                </div>
